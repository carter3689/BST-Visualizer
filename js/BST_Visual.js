...
BST.FOREGROUND_COLOR = "#ffffff";
BST.BACKGROUND_COLOR = "#03a9f4";
...
BST.prototype.init = function(am, w, h){
    ...
    this.nextIndex = 0;
    this.commands = [];
    this.cmd("CreateLabel", 0, "", 20, 20, 0);
    this.nextIndex = 1;
...
BST.prototype.addControls = function(){
    this.insertField = addControlToAlgorithmBar("Text", "", "form-control");
    this.insertField.onkeydown = this.returnSubmit(this.insertField, this.insertCallback.bind(this), 4);
    this.insertButton = addControlToAlgorithmBar("Button", "Insert", "btn btn-primary");
    this.insertButton.onclick = this.insertCallback.bind(this);
    this.deleteField = addControlToAlgorithmBar("Text", "", "form-control");
    this.deleteField.onkeydown = this.returnSubmit(this.deleteField,  this.deleteCallback.bind(this), 4);
	this.deleteButton = addControlToAlgorithmBar("Button", "Delete", "btn btn-primary");
	this.deleteButton.onclick = this.deleteCallback.bind(this);
	this.findField = addControlToAlgorithmBar("Text", "", "form-control");
	this.findField.onkeydown = this.returnSubmit(this.findField,  this.findCallback.bind(this), 4);
	this.findButton = addControlToAlgorithmBar("Button", "Find","btn btn-primary");
	this.findButton.onclick = this.findCallback.bind(this);
	this.printButton = addControlToAlgorithmBar("Button", "Print","btn btn-primary");
...
BST.prototype.deleteCallback = function(event){
    ...
    if(deletedValue != ""){
        ...
        this.implementAction(this.deleteElement.bind(this), deletedVlaue);
    }
}
...
BST.prototype.printTree = function(unused){
    ...
    if (this.treeRoot != null){
        ...
        this.cmd("CreateHightLightCircle", this.hightlightID, BST.HIGHLIGHT_CIRCLE_COLOR, this.treeRoot.x, this.treeRoot.y);
        this.xPosOfNextLabel = BST.FIRST_PRINT_POS_X;
        this.yPosOfNextLabel = this.first_print_pos_y;
        this.printTreeRec(this.treeRoot);
        this.cmd("Delete", this.hightlightID);
        this.cmd("Step");
...
BST.prototype.printTreeRec = function(tree){
    this.cmd("Step");
    if (tree.left != null){
        this.cmd("Move", this.hightlightID, tree.left.x, tree.left.y);
        this.printTreeRec(tree.left);
        this.cmd("Move", this.hightlightID, tree.x, tree.y);
        this.cmd("Step");
    }
    ...
    if (tree.right != null){
        this.cmd("Move", this.hightlightID, tree.right.x, tree.right.y);
